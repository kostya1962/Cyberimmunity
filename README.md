...
3. Злоумышленник применяет подстановку учётных данных, собранных с других аккаунтах на тех или иных платформах (credential stuffing).
...
Получение конфиденциальной информации лицом, не имеющим на это прав:
1. Сотрудник получает доступ к системам и данным.
2. Доступ предоставляется без учета необходимости для выполнения обязанностей.
3. Сотрудник случайно или умышленно изменяет или удаляет данные.
4. Утечка информации или искажение данных.
