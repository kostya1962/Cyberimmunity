...
4. **Предоставление возможности осуществления доставки**: магазин будет предлагать различные варианты доставки (для физических книг) и моментальный доступ к цифровым версиям книг (электронные и аудиокниги).
...
Необходимо разработать архитектуру для web-приложения для описанного выше книжного интернет-магазина, задача которого: эффективно управлять каталогом книг, позволяя клиентам выбирать и покупать необходимые книги. Web-ресурс должен включать базу данных, хранящую персональные данные, а также предоставлять возможность осуществлять транзакции для покупки книг.
### Цели и Предположения Безопасности (ЦПБ)

В качестве целей безопасности можем выделить следующие пункты:
1. Обеспечение целостности персональных данных при обработке и передаче
...
4. Обеспечение защиты данных о платеже от перехвата, искажения или подмены
...
| ---------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| SQL-инъекции                                                     | SQL-инъекции возникают, когда злоумышленник может вставить вредоносный SQL-код в поля ввода, например, в форму поиска товаров или аутентификации                                                                                                                                       | [CWE-89](https://cwe.mitre.org/data/definitions/89.html)</br>[CWE-73](https://cwe.mitre.org/data/definitions/73.html)                                                                                                                                                                                                      |
| XSS (Межсайтовый скриптинг, Cross-Site Scripting)                | XSS-атаки позволяют злоумышленнику внедрить вредоносные скрипты на страницы интернет-магазина                                                                                                                                                                                          | [CWE-80](https://cwe.mitre.org/data/definitions/80.html)</br> [CWE-87](https://cwe.mitre.org/data/definitions/87.html)</br>[CWE-79](https://cwe.mitre.org/data/definitions/79.html)                                                                                                                                        |
| CSRF (Межсайтовая подделка запросов, Cross-Site Request Forgery) | CSRF-атака использует авторизованную сессию пользователя для выполнения несанкционированных действий от его имени                                                                                                                                                                      | [CWE-352](https://cwe.mitre.org/data/definitions/352.html)                                                                                                                                                                                                                                                                 |
| Уязвимость при неверной авторизации и аутентификации             | Ошибки в проверке прав доступа могут позволить злоумышленникам получить доступ к страницам администратора или другим закрытым ресурсам, таким как учетные записи пользователей                                                                                                         | [CWE-287](https://cwe.mitre.org/data/definitions/287.html)</br>[CWE-521](https://cwe.mitre.org/data/definitions/521.html)</br>[CWE-306](https://cwe.mitre.org/data/definitions/306.html)</br>[CWE-1390](https://cwe.mitre.org/data/definitions/1390.html)                                                                  |
| Неправильное управление сессиями                                 | Аутентификация пользователя или иное создание нового сеанса пользователя без аннулирования любого существующего идентификатора сеанса дает злоумышленнику возможность украсть аутентифицированные сеансы                                                                               | [CWE-384](https://cwe.mitre.org/data/definitions/384.html)                                                                                                                                                                                                                                                                 |
| Неправильная валидация данных                                    | Неправильная или отсутствующая валидация данных может привести к множеству уязвимостей. Например, злоумышленник может ввести некорректные данные в формы регистрации или оформления заказа, что приведёт к ошибкам в бизнес-логике приложения или даже к выполнению вредоносного кода. | [CWE-20](https://cwe.mitre.org/data/definitions/20.html)</br>[CWE-100](https://cwe.mitre.org/data/definitions/100.html)</br>[CWE-1173](https://cwe.mitre.org/data/definitions/1173.html)</br>[CWE-1174](https://cwe.mitre.org/data/definitions/1174.html)</br>[CWE-1287](https://cwe.mitre.org/data/definitions/1287.html) |
| Открытые перенаправления ('Open Redirect')                       | Открытые перенаправления позволяют злоумышленнику перенаправить пользователя на вредоносный сайт через легитимный домен интернет-магазина. Это может быть использовано для фишинга, кражи данных или других атак                                                                       | [CWE-601](https://cwe.mitre.org/data/definitions/601.html)                                                                                                                                                                                                                                                                 |
| Уязвимость к отказу в обслуживании (DoS/DDoS)                    | Злоумышленник может отправлять чрезмерное количество запросов к серверу, перегружая систему и делая её недоступной для легитимных пользователей. Это может быть вызвано отсутствием ограничения частоты запросов или недостаточной оптимизацией запросов к базе данных                 | [CWE-400](https://cwe.mitre.org/data/definitions/400.html)                                                                                                                                                                                                                                                                 |
| Уязвимости в кроссдоменных запросах (CORS)                       | Неправильная настройка CORS, позволяющая злоумышленникам выполнять запросы от имени пользователя                                                                                                                                                                                       | [CWE-942](https://cwe.mitre.org/data/definitions/942.html)</br>[CWE-346](https://cwe.mitre.org/data/definitions/346.html)                                                                                                                                                                                                  |
| Уязвимости в логировании и мониторинге                           | Недостаточное логирование действий пользователей затрудняет выявление атак                                                                                                                                                                                                             | [CWE-117](https://cwe.mitre.org/data/definitions/117.html)</br>[CWE-223](https://cwe.mitre.org/data/definitions/223.html)</br>[CWE-532](https://cwe.mitre.org/data/definitions/532.html)</br>[CWE-778](https://cwe.mitre.org/data/definitions/778.html)                                                                    |
| Уязвимости в механизмах обработки платежей                       | Неправильная обработка платежной информации может привести к мошенничеству.                                                                                                                                                                                                            | [CWE-327](https://cwe.mitre.org/data/definitions/327.html)</br>[CWE-295](https://cwe.mitre.org/data/definitions/327.html)</br>[CWE-311](https://cwe.mitre.org/data/definitions/311.html)                                                                                                                                   |
...
2. Система использует CAPTCHA для предотвращения автоматизированных атак.
3. Пользоваетль успешно проходит CAPTCHA.
4. Система требует пройти многофакторную аутентификацию.
5. Пользователь успешно проходит проверку (указывает код из SMS или другими способами) с  использованием достаточно сильного пароля.
6. Если вход в систему выполняется с неизвестного устройства или из другой страны, пользователю отправляется уведомление с предложением подтвердить, что вход выполнялся им.
7. При осуществлении особо чувствительных операций, таких как изменение данных аккаунта, просмотр финансовой информации или оформление заказов, система проверяет уровень привелегий пользователя.
...
В ходе анализа предметной области были выделены ключевые ценности бизнеса, поставлены основные цели безопасности, которые включали защиту данных пользователей, предотвращали мошенничество, обеспечивали целостность и доступность веб-ресурсов. Выявлены слабые места и возможные угрозы и определены сценарии, где эти угрозы могли бы реализоваться.
